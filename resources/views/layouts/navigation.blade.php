            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-2xl">
                        <span class="filter drop-shadow-sm">📚</span>
                        <span class="font-black text-indigo-600 dark:text-indigo-400 mr-2">مكتبتي</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('favorites.index')" :active="request()->routeIs('favorites.index')" class="dark:text-gray-300">
                        {{ ('المفضلة') }}
                    </x-nav-link>
                </div>
            </div>
